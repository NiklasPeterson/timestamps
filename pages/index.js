...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Generate Timestamps for Discord and More | Timestamps</title>
      ...
      <ScWrapper>
        ...
        <ScInner>
          ...
          <ScMain>
            ...
            <ScDiscordButton href="https://discord.com/oauth2/authorize?client_id=1031598414280015915" target='_blank'>
...
const ScDiscordButton = styled.a`
  display: flex;
  height: 32px;
  width: fit-content;
