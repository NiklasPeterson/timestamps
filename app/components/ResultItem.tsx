...
const ResultItem: React.FC<ResultItemProps> = ({ children, label, value }) => {
  const handleButtonClick = () => {
    ...
    toast.success('Timestamp copied to your clipboard!', {
      className: 'backgroundPrimary contentPrimary borderSecondary',
      icon: <SuccessIcon />,
    });
  };

  return (
    <div className="flex items-center backgroundPrimary shadow-xs dark:shadow-none gap-2 p-2 rounded-lg">
