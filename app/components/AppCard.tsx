...
const AppCard: React.FC<AppCardProps> = ({ href, imageSrc, imageAlt, title, description }) => (
  ...
  >
    <div className='relative overflow-hidden flex px-2 py-2 w-full rounded-xl gap-3 items-center backgroundSecondary border borderSecondary backgroundHoverOverlay shadow-sm dark:shadow-none md:w-fit'>
      <Image
        src={imageSrc}
        alt={imageAlt}
        width={36}
