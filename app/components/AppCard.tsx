...
const AppCard: React.FC<AppCardProps> = ({ href, imageSrc, imageAlt, title, description }) => (
  ...
  >
    <div className='relative overflow-hidden flex px-2 py-2 w-fit rounded-xl gap-3 items-center justify-center backgroundSecondary border borderSecondary backgroundHoverOverlay'>
      <Image
        src={imageSrc}
        alt={imageAlt}
        width={36}
